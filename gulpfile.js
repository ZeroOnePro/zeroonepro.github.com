...
gulp.task('firewall:encrypt', () => {
  return gulp.src('_protected/2021/node.js/chapter\ 1/*.*')
    .pipe(encrypt('password'))
    .pipe(gulp.dest('_posts/2021/node.js/chapter\ 1'));
});

gulp.task('firewall:watch', () => {
  gulp.watch('_protected/2021/node.js/chapter\ 1/*.*', gulp.series('firewall:encrypt'));
});
